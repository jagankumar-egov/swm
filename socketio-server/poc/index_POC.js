...
location_nsp.on('connection', function(socket) {
    ...
    socket.on('data', function(data) {
        ...
        var current_day =  moment().tz("Asia/Kolkata").format("MM-DD-YYYY");
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            var date_of_parsedData = moment.tz(epoch_time_of_data,"Asia/Kolkata").format("MM-DD-YYYY")            
            if (date_of_parsedData==current_day){
                console.log(date_of_parsedData);
